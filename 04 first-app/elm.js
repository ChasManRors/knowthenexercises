		...
		switch (_p0.ctor) {
			case 'AddCalorie':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						total: model.total + A2(
							_elm_lang$core$Result$withDefault,
							0,
							_elm_lang$core$String$toInt(model.val))
					});
			case 'Clear':
				return _elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {total: a, val: b};
	});
var _user$project$Main$initModel = A2(_user$project$Main$Model, 0, '');
var _user$project$Main$Clear = {ctor: 'Clear'};
var _user$project$Main$Val = function (a) {
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$Val),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$value(
									_elm_lang$core$Native_Utils.eq(model.total, 0) ? '' : _elm_lang$core$Basics$toString(model.total)),
								_1: {ctor: '[]'}
							}
						}
					},
